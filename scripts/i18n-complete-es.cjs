...
async function main() {
  ...
  for (const namespace of NAMESPACES) {
    ...
    const targetPath = path.join(LOCALE_ROOT, "es", `${namespace}.json`);
  ...
  console.log(`Spanish locale completion done. added=${counters.added} translated=${counters.translated} cache=${cache.size}`);
}
